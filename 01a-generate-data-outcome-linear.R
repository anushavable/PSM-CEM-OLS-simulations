...
# We generate all 10,000 datasets at once such that each column is a different 
# dataset with 80,000 observations (i.e. 20,000 observations for each of our 
# 4 variables), and then separate each column into a dataset in Stata.
...
# coefficients to vary correlation & common support - 
# values we used are presented in Appendix Table 7.
b <- NULL
c <- NULL
d <- NULL
e <- NULL
