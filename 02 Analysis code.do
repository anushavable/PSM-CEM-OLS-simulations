...
/* Set up excel files to record resutls from each simulation */
	...
	/* create excel file for analysis with all confounders measured & correctly specified */
		capture putexcel 	A1 = ("OLS_N") 						///		
							...
							AF1 = ("cem_d_exp")					///
							AG1 = ("cem_d_unexp")				///
							using no_confounding, replace 		// all confounders measured & correctly specified 
	...
	/* create excel file for analysis when x1 is an unmeasured confounder */
		capture putexcel 	A1 = ("OLS_N") 						///		
							...
							using x1_unmeasured, replace  // "un" means unmeasured confounder 
	...
	/* create excel file for analysis when x2 is an unmeasured confounder */
		capture putexcel 	A1 = ("OLS_N") 				
							...
							using x2_unmeasured, replace  		// "un" means unmeasured confounder
...
/******************************************************************************************************************************************************
		...
		Analysis code when there are no unmeasured confounders 
...
/******************************************************************************************************************************************************
		...
		Analysis code when x1 is an unmeasured confounder 
...
/******************************************************************************************************************************************************
		...
		Analysis code when x2 is an unmeasured confounder 
